...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducción al español de todos los mensajes de validación de Laravel.
    | Antes el proyecto no tenía carpeta lang/, así que cualquier formulario
    | sin un mensaje personalizado mostraba el texto en inglés por defecto.
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Nombres legibles de los campos (en español)
    |--------------------------------------------------------------------------
    |
    | Se usan para reemplazar :attribute en los mensajes de arriba. Sin esto,
    | Laravel muestra el nombre técnico del campo tal cual (ej. "contenido_pub"
    | en vez de "contenido de la publicación").
    */
    'attributes' => [
        'nombre'               => 'nombre',
        'apellido'             => 'apellido',
        ...
        'titulo_pub'           => 'título de la publicación',
        'contenido_pub'        => 'contenido de la publicación',
        'imagen_pub'           => 'imagen',
        ...
        'observacion_visita'   => 'observación de visita',
    ],
