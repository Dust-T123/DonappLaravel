@extends('layouts.app')
@section('title', 'Términos y Condiciones – Donapp')
@section('styles')
    ...
    <footer class="main-footer">
        <div class="footer-content">
            <div class="footer-brand">
                <a href="{{ route('home') }}">
                    <img id="footerLogo"
                         src="{{ asset('assets/uploads/Red-Logo.png') }}"
                         alt="Donapp"
                         class="footer-logo">
                </a>
...
@section('scripts')
<script src="{{ asset('assets/js/terminos.js') }}"></script>
@endsection