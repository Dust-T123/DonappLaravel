    ...
    <form action="<?php echo e(route('registro.post')); ?>" method="POST" class="form-grid" id="registerForm">
        ...
        <div class="input-group">
            ...
            <input type="text" name="nombre" id="nombre"
                   ...
                   required minlength="3" maxlength="100" onkeypress="return soloLetras(event)">
        </div>
        ...
        <div class="input-group">
            ...
            <input type="text" name="apellido" id="apellido"
                   ...
                   required minlength="2" maxlength="100" onkeypress="return soloLetras(event)">
        </div>
        ...
        <div class="input-group">
            ...
            <input type="text" name="numDocumento" id="numero_doc"
                   ...
                   required minlength="4" maxlength="15" pattern="[A-Za-z0-9]{4,15}"
        ...
        <div class="input-group">
            ...
            <p class="form-hint" style="font-size:0.78rem;color:var(--text-muted,#777);margin-top:4px">Debes tener al menos 14 años para registrarte.</p>
        </div>
