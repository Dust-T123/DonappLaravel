                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td-actions">
                                    ...
                                    <form action="<?php echo e(route('admin.visitas.estado', $v->idVisita)); ?>" method="POST" style="display:inline">
                                        <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\DonappLaravel\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>