...
<div id="landing-page" class="page active">
    ...
    <section class="hero-video-section">
        ...
        <div class="hero-video-content">
            <a href="{{ route('home') }}">
                <img src="{{ asset('assets/uploads/White-Logo.png') }}" alt="Donapp Logo" class="logo-site">
            </a>
            <h1 class="hero-title">
            ...
            <div class="hero-buttons">
                ...
                <a class="btn btn-secondary" href="{{ route('registro') }}">Registrarse</a>
            </div>
...
<<<<<<< HEAD:resources/views/public/index.blade.php
...
>>>>>>> 167c2457c2d76efa723cd44d76f2e025d0fdcc59:donapp/resources/views/public/index.blade.php
...
<footer class="main-footer">
    <div class="footer-content">
        <div class="footer-brand">
            <a href="{{ route('home') }}">
                <img src="{{ asset('assets/uploads/Red-Logo.png') }}" alt="Donapp" class="footer-logo">
            </a>
    ...
    <div class="footer-bottom">
        <p>&copy; {{ date('Y') }} Donapp – Corporación Educativa y Social WALDORF. Todos los derechos reservados.</p>
    </div>
</footer>
